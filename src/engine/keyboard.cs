...
static class keyboard
{
    ...
    int readLine(Window window, string line, Vector2 position, const std::function<void(Window)>& render,
                           string prefix)
    {
    ...
    int readLineProcessKey(SDL_Event event, string line, string::iterator cursor)
    {
